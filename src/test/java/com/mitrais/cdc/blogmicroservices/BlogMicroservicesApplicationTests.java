...
public class BlogMicroservicesApplicationTests {
    ...
    public void updateBlog() throws Exception {
        ...
        PostPayload postPayload = new PostPayload(Long.parseLong("3"),"Test Blog 3","Ini Content Baru Update",  zonedDateTime, Long.parseLong("1"), "Enterprise Application Integration");
        String postJson = mapper.writeValueAsString(postPayload);
        ...
        mockMvc.perform(builder)
                ...
                .andExpect(jsonPath("$['title']", containsString("Test Blog 3")));
